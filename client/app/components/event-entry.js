              ...
              <div className="col-md-12">
                <div className="media">
                  ...
                  <div className="media-body">
                    <h3 className = "media-heading entry-heading"><Link to={"/event-details/" + this.props._id} className="event-links">{this.props.event_name}</Link><a href={this.props.org_link}>{this.props.org}</ a>
